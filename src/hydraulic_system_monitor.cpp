...
public:
  HydraulicSystemMonitor(std::string temp, std::string level, std::string pressure) : hydraulic_oil_temperature(temp), hydraulic_oil_tank_fill_level(level), hydraulic_oil_pressure(pressure){}
  ...
  void getHydraulicData(std::string &temp, std::string &level, std::string &pressure) const {
